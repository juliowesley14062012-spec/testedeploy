...
import { loadAppointments, saveAppointments, subscribeToAppointments } from '../services/firestoreService';
      ...
      <div className="bg-white/95 backdrop-blur-sm rounded-xl border border-gray-200 p-8 shadow-lg">
        ...
        {showForm && (
          <div className="mb-8 bg-gray-50 rounded-lg p-6 border border-gray-200">
            <h3 className="text-xl font-semibold text-gray-800 mb-4">Novo Agendamento</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-gray-800 font-medium mb-2">Horário</label>
                  <input
                    type="time"
                    value={formData.time}
